...
// ============================================================
// LIGHT THEME: Pale Blue on White for light mode
// ============================================================
export const lightTheme: Theme = {
  ...
  colors: {
    ...
    bgGlass: 'rgba(14,40,80,0.03)',
    textPrimary: '#06233a',
    textSecondary: '#16557a',
    textMuted: '#4a6b7f',
    border: 'rgba(14,165,233,0.12)',
    borderGlow: 'rgba(0,212,255,0.12)',
    gradientHero: 'linear-gradient(135deg, #ffffff 0%, #f7fbff 100%)',
    gradientCard: 'linear-gradient(135deg, rgba(14,165,233,0.04) 0%, rgba(0,212,255,0.02) 100%)',
    gradientButton: 'linear-gradient(135deg, #0ea5e9 0%, #00d4ff 100%)',
    gradientTextStart: '#0369a1',
    gradientTextEnd: '#06283d',
    success: '#10b981',
    warning: '#f59e0b',
    error: '#ef4444',
  },
...
// ============================================================
// LIGHT RED THEME: Light variant of the red theme (Red + White)
// ============================================================
export const lightRedTheme: Theme = {
  ...
  colors: {
    ...
    secondary: '#2b0a0a',
    accent: '#ff6b6b',
    accentGlow: 'rgba(255,107,107,0.16)',
    bgDark: '#ffffff',
    bgMid: '#fff5f5',
    bgLight: '#fff0f0',
    bgCard: 'rgba(255,255,255,0.9)',
    bgGlass: 'rgba(14,40,80,0.03)',
    textPrimary: '#2b0a0a',
    textSecondary: '#6b1f1f',
    textMuted: '#9b4545',
    border: 'rgba(239,68,68,0.12)',
    borderGlow: 'rgba(255,107,107,0.12)',
    gradientHero: 'linear-gradient(135deg, #ffffff 0%, #fff5f5 100%)',
    gradientCard: 'linear-gradient(135deg, rgba(239,68,68,0.04) 0%, rgba(255,107,107,0.02) 100%)',
    gradientButton: 'linear-gradient(135deg, #ef4444 0%, #ff6b6b 100%)',
    gradientTextStart: '#ff6b6b',
    gradientTextEnd: '#ef4444',
    success: '#10b981',
